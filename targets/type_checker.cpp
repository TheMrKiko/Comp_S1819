...
void m19::type_checker::do_fun_body_node(m19::fun_body_node * const node, int lvl) {
  //FIXME
}
...
void m19::type_checker::do_fun_call_node(m19::fun_call_node * const node, int lvl) {
  //FIXME
}
